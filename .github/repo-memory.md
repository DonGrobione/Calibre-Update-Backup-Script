...
- The maintained entry point is `Calibre Update Backup.ps1`; `Legacy/Calibre Update Backup.bat` is retained only for reference.
- The script targets Windows PowerShell 5.1 and uses the StratoHiDriveUtils module, 7-Zip, and the STRATO HiDrive client.
